...
global.mess = {
    success: 'تم ياقلبي✓',
    admin: '*✭〘💙✨هـذي المـيـزه للمشـرفــيـن اسـف ياقلبي لازم اشـــراف〙✭*!! ',
    botAdmin: '*✭〘💙✨لازم الـبـوت يـحصل اشـراف ياحـبـي〙✭* !',
    owner: '*✭〘💙✨هذي للمالـــك فقط〙✭*!',
    group: '*✭〘💙✨الـمـيزه تشتغل بالجـــمـــوعــات فقـــــــط〙✭*!',
    private: 'الميزه المستخدمة فقط للدردشة الخاصة!',
    bot: 'هذي بس للبوت',
    wait: '*✭〘💙✨استنــــــــــــى ياقلـــــبي يتحمل... 〙✭*',
    linkm: 'أين الرابط?',
    error: 'ايرور!!',
